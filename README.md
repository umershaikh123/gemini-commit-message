...
![feature-icon](https://i.imgur.com/your-image-url.png) <!-- You can replace this with a screenshot or GIF -->
...
5.  Click the **✨** (sparkle) icon in the Source Control title bar.
